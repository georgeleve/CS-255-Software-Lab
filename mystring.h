 ...
 */
extern size_t ms_length(const char *s);
extern size_t ms_length(const char s[]);
/*
 * Function: ms_copy
 * ----------------------------
 ...
 */
extern char *ms_copy(char *s, const char *ct);
extern char *ms_copy(char s[], const char ct[]);
/*
 * Function: ms_ncopy
 * ----------------------------
 ...
 */
extern char *ms_ncopy(char *s, const char *ct, size_t num);
extern char *ms_ncopy(char s[], const char ct[], size_t num);
/*
 * Function: ms_concat
 * ----------------------------
 ...
 */
extern char *ms_concat(char *s, const char *ct);
extern char *ms_concat(char s[], const char ct[]);
/*
 * Function: ms_nconcat
 * ----------------------------
 ...
 *   returns: a pointer to the resulting string s.
 */
extern char *ms_nconcat(char *s, const char *ct, size_t num);
extern char *ms_nconcat(char s[], const char ct[], size_t num);
/*
 * Function: ms_compare
 * ----------------------------
 ...
 */
extern int ms_compare(const char *cs, const char *ct);
extern int ms_compare(const char cs[], const char ct[]);
/*
 ...
 *  returns: value < 0 or value == 0 or value > 1
 */
extern int ms_ncompare(const char *cs, const char *ct, size_t num);
extern int ms_ncompare(const char cs[], const char ct[], size_t num);
/*
 * Function:  ms_search
 * ----------------------------
 ...
 */
extern const char *ms_search(const char *cs, const char *ct);
extern const char *ms_search(const char cs[], const char ct[]);
